    ...
    <div className="flex flex-col gap-10 *:flex *:flex-col *:gap-2">
      ...
      <div>
        ...
        <span>
          ...
          <br /><br />
          <b>Here&apos;s an example in JavaScript using my package - <a href="https://github.com/jakeayy/Yoyo-MD5">yoyo-md5</a>:</b>
...
function Footer() {
  return <footer className="flex flex-col place-self-center p-10 w-3/4 text-secondary text-center">
    <span>Created with <span className="animate-pulse text-primary">&#9829;</span> by <a href="https://meowpa.ws">jakeayy</a></span>
